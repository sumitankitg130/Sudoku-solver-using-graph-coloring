...
class App:
    def __init__(self):
        ...
        self.grid = []
        self.getPuzzle("4")                      # Extracting puzzzle fom Web
        self.load()
...
##### HELPER FUNCTIONS #####
    ...
    def getPuzzzle(self, difficulty):
        solver = Solver()
        board = solver.solve()
    ...
    def loadButtons(self):                                      #load Buttons
        self.playingButtons.append(Button(  10, 40, WIDTH//7, 40,
                                            function=self.checkAllCells,
                                            colour=(27,142,207),
                                            text="Check"))
        self.playingButtons.append(Button(  110, 40, WIDTH//7, 40,
                                            colour=(117,172,112),
                                            function=self.getPuzzle,
                                            params="1",
                                            text="Easy"))
        self.playingButtons.append(Button(  WIDTH//2-(WIDTH//7)//2-50, 40, WIDTH//7, 40,
                                            colour=(204,197,110),
                                            function=self.getPuzzle,
                                            params="2",
                                            text="Medium"))
        self.playingButtons.append(Button( 300, 40, WIDTH//7, 40,
                                            colour=(199,129,48),
                                            function=self.getPuzzle,
                                            params="3",
                                            text="Hard"))
        self.playingButtons.append(Button(  400, 40, WIDTH//7, 40,
                                            colour=(207,68,68),
                                            function=self.getPuzzle,
                                            params="4",
                                            text="Evil"))
